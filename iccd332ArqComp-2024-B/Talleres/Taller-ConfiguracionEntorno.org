...
2. **Edgar Endara:** <C-g>. <Cancelar acción o comando>
...
**Comandos Difíciles**
1. **Evan Matango:** <C-x k>. <Matar un buffer>
2. **Edgar Endara:** <M-x replace - string>. <Reemplazar texto en todo el archivo>
...
razones al respecto.
- [X] Verificación versión Emacs desde Emacs con comando shell.
- [X] Verificación versión \LaTeX desde Emacs con comando shell.
- [X] Verificación versión Python desde Emacs con comando shell. 
