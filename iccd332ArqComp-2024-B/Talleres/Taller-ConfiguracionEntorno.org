...
#+author:A-EVAN, NICOLAS, MATANGO, HINOSTROSA, KAREN SUAREZ
...
1. Verificacion de entorno mamba/anaconda
   1. Active WSL (si aplica) y su entorno de trabajo.
   2. Ejecute ~conda info~ con ~C-c C-c~ dentro del bloque de código.
   3. Si el comando falla, active un entorno con ~conda activate iccd332~ e intente de nuevo.
