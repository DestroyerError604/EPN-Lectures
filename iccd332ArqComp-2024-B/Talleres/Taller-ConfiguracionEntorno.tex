<<<<<<< Updated upstream
% Created 2026-04-24 Fri 12:09
=======
% Created 2026-04-22 Wed 23:30
>>>>>>> Stashed changes
...
\section{Objetivos}
<<<<<<< Updated upstream
\label{sec:orge4c71a2}
=======
\label{sec:org219fddd}
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
\label{sec:org326180c}
=======
\label{sec:orgba31c56}
>>>>>>> Stashed changes
...
\section{Actividades}
<<<<<<< Updated upstream
\label{sec:orgeb852f8}
\subsection{Configuración de WSL con Ubuntu, \LaTeX, Python e Emacs}
\label{sec:org6ed92ea}
=======
\label{sec:org1432c23}
\subsection{Configuración de WSL con Ubuntu, \LaTeX, Python e Emacs}
\label{sec:org5d5a42a}
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
\label{sec:orga04160f}
=======
\label{sec:org48b9c71}
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
\label{sec:org320a883}
=======
\label{sec:org225e6e8}
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
\label{sec:org90cea3b}
=======
\label{sec:org7479a5a}
>>>>>>> Stashed changes
...
\item \textbf{\textbf{Edgar Endara:}} <C-g>. <Cancelar acción o comando>
...
\begin{enumerate}
\item \textbf{\textbf{Evan Matango:}} <C-x k>. <Matar un buffer>
\item \textbf{\textbf{Edgar Endara:}} <M-x replace - string>. <Reemplazar texto en todo el archivo>
...
<<<<<<< Updated upstream
\label{sec:orgc514de8}
=======
\label{sec:orgd0bc137}
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
\label{sec:org8bfee3a}
=======
\label{sec:org64e4c54}
>>>>>>> Stashed changes
...
razones al respecto.
\begin{itemize}
\item[{$\boxtimes$}] Verificación versión Emacs desde Emacs con comando shell.
\item[{$\boxtimes$}] Verificación versión \LaTeX desde Emacs con comando shell.
\item[{$\boxtimes$}] Verificación versión Python desde Emacs con comando shell.
...
\label{sec:orgbbe5687}
=======
\subsection{Problemas con la Tarea:}
\label{sec:org0aaf427}
>>>>>>> Stashed changes
\begin{itemize}
