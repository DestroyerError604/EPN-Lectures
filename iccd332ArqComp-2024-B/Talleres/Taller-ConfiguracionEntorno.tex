...
\usepackage{tabularx}
\usepackage{longtable}
\author{A-EVAN MATANGO   D-KAREN SUAREZ}
\date{2026-04-08}
\title{Taller de Configuracion de Entorno WSL}
\hypersetup{
 pdfauthor={A-EVAN MATANGO   D-KAREN SUAREZ},
...
\begin{enumerate}
\item Active WSL (si aplica) y su entorno de trabajo.
\item Ejecute \texttt{conda info} con \texttt{C-c C-c} dentro del bloque de código.
\item Si el comando falla, active un entorno con \texttt{conda activate iccd332} e intente de nuevo.
\end{enumerate}
...
\begin{center}
\includegraphics[width=.9\linewidth]{./KarenImagen.png}
\end{center}
\begin{center}
\includegraphics[width=.9\linewidth]{./karen.png}
\end{center}
\begin{center}
\includegraphics[width=.9\linewidth]{./karen.png}
\end{center}
...
Albert Einstein & a.einstein@relativo.com & colaborador\\[0pt]
